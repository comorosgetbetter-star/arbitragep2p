...
const AccountSettings = ({ currentEmail, onEmailUpdated }: Props) => {
  ...
  return (
    <div className="glass-card rounded-2xl p-6 mb-6">
      <h2 className="text-lg font-display font-semibold mb-4">Account Settings</h2>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Button size="sm" variant="glow" onClick={handleUpdateEmail} disabled={savingEmail} className="flex-1">
                {savingEmail ? <Loader2 className="h-3 w-3 animate-spin mr-1" /> : <Check className="h-3 w-3 mr-1" />}
                Save
              </Button>
